...
const meta: Meta<AmexUAEFTSStatementRequestFormComponent> = { title: 'AMEX/Forms/UAEFTSStatementRequestForm', component: AmexUAEFTSStatementRequestFormComponent, tags: ['autodocs'] };
export default meta;
