...
const meta: Meta<AmexTaxInvoiceDeliveryFormComponent> = { title: 'AMEX/Forms/TaxInvoiceDeliveryForm', component: AmexTaxInvoiceDeliveryFormComponent, tags: ['autodocs'] };
export default meta;
