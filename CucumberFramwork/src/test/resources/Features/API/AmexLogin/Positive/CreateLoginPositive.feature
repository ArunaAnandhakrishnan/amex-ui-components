...
Feature: Create Role Based Login Positive Scenario with Login API
  ...
  Scenario: Create Amex BTA Corporate Sub Admin Login
    Given i have "CreateOnlsLoginEndpoint" api request with template "CreateOnlsLogin" and following details
